...
# Resolve all paths relative to where the app ACTUALLY lives, not CWD or temp dir
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # 0. Load DB path from settings FIRST
        self._load_database_path_from_settings()
    ...
    def show_about(self):
        about_message = (
            ...
            f"© Nguyễn Duy Trường\n\n"
            "✨ ĐIỂM MỚI TRONG V5.0.3:\n"
            "✅ Sync Delete Đồng Bộ:\n"
            "   Xóa bệnh nhân sẽ chờ Cloud xóa xong, Mobile App không còn thấy dữ liệu đã xóa.\n"
            "✅ Fix Zombie Data:\n"
            "   Dữ liệu đã xóa không còn tự động hồi sinh từ Cloud.\n\n"
            "----------------------------\n"
            "✨ ĐIỂM MỚI TRONG V5.0:\n"
    ...
    def load_settings(self):
        try:
            if os.path.exists(self.settings_file):
                ...
                if "consultation_fee" in settings:
                    config.set_consultation_fee(settings["consultation_fee"])
    ...
    def _load_database_path_from_settings(self):
        ...
        try:
            ...
            pass  # Silent fallback to default
